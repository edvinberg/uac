...
<div class="home-slider">
	<div id="slider" class="sl-slider-wrapper">
		<div class="sl-slider">
			<div id="top-bubble">
<!--                <img class="bubble-bg" src="http://v3.const.vinterdagen.se/wp-content/uploads/2018/11/hornetwhite.png">-->
                <div id="top-bubble-meta"> <a>
				<!--<img class="bubble-gif" loop="infinite" src="https://www.wayoutwest.se/wp-content/themes/wayoutwest/img/2018/gfx-tickets-gif.gif">-->
			
				<p class="i-title">	<b>Öppettider i City</b></p>
<p class="item-1">
				Vardagar           10 – 19</p>
